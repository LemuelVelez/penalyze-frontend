        ...
        <div className="mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="grid flex-1 items-center gap-10 py-10 lg:grid-cols-2 lg:py-16">
            <div className="max-w-3xl">
              <p className="mb-4 inline-flex rounded-full border bg-card px-4 py-2 text-sm font-semibold text-muted-foreground shadow-sm">
              ...
              <form
                ...
                className="mt-8 flex flex-col gap-3 rounded-3xl border bg-card p-3 shadow-xl shadow-black/5 sm:flex-row sm:items-center"
              >
            ...
            <div className="rounded-3xl border bg-card p-5 shadow-xl shadow-black/5 sm:p-6">
          ...
          <div className="mb-6 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 lg:w-auto">
              <div className="rounded-2xl border bg-card px-5 py-4">
                ...
                <p className="text-2xl font-black">{totalAbsences}</p>
              </div>
              <div className="rounded-2xl border bg-card px-5 py-4">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  {lookup.attendance.map((row) => (
                    <article key={row.id} className="rounded-2xl border bg-background p-4">
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        ...
                        <p className="text-sm font-bold">{row.no_of_absences} absence/s</p>
                      </div>
                    ...
                    <tbody>
                      {lookup.attendance.map((row) => (
                        <tr key={row.id} className="border-b last:border-b-0">
                          ...
                          <td className="px-3 py-3">{row.no_of_absences}</td>
            ...
            <div className="rounded-3xl border bg-card p-4 shadow-sm sm:p-6">
              ...
              {lookup.fines.length ? (
                ...
                <div className="rounded-2xl border border-dashed bg-background p-6 text-center text-sm font-semibold text-muted-foreground">
                  No fine record found for this Student ID.
                </div>
              )}
            </div>
          </div>
