...
function getStudentAbsentEventSummaries(
  ...
  const hasPositiveAttendanceWithoutExplicitAbsences =
    uniqueAttendance.some((record) => hasAttendanceEventIdentity(record, eventById)) && explicitAbsentRecords.length === 0;
  const verifiedAbsenceCount =
    hasPositiveAttendanceWithoutExplicitAbsences && !hasLinkedFineEvent
      ? 0
